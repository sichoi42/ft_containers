...
namespace ft {
	...
	inline bool operator==(const random_access_iterator<T1>& x, const random_access_iterator<T2>& y) {
	...
	operator+(const random_access_iterator<T1>& x, const random_access_iterator<T2>& y) {
		return x.base() + y.base();
	}
